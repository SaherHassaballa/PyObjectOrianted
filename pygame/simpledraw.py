...
while True:
    ...
    # 8 - Do any "per frame" actions (none here)
    ...
    pygame.draw.line(window, BLUE, (20, 60), (60, 60), 4)   # bottom
    pygame.draw.line(window, BLUE, (60, 20), (60, 60), 4)   # right
    ...
    pygame.draw.aaline(window, RED, (500, 400), (540, 470), 4)
